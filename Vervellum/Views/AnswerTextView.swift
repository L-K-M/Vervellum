...
///
/// TextKit 1, deliberately — see `MeasuringTextView`, which builds the stack and holds
/// the reasoning, along with why `sizeThatFits` below is not optional for any text view
/// this panel hosts.
...
final class HoverTextView: MeasuringTextView {
