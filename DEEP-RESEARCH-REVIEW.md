...
| G3 | A bounded evidence round on `insufficient` | landed in #103 |
| G4 | Sub-question decomposition in the plan | landed in #102 |
...
| G7 | Deep-mode answer structure from the sub-questions | landed in #102 |
